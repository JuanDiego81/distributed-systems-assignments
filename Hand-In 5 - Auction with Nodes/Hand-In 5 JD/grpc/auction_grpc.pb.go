...
type AuctionServiceClient interface {
	...
	Replicate(ctx context.Context, in *ReplicationRequest, opts ...grpc.CallOption) (*ReplicationAck, error)
}
...
func (c *auctionServiceClient) Replicate(ctx context.Context, in *ReplicationRequest, opts ...grpc.CallOption) (*ReplicationAck, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AuctionServiceServer interface {
	...
	// Internal replication RPC used only between nodes
	Replicate(context.Context, *ReplicationRequest) (*ReplicationAck, error)
...
func (UnimplementedAuctionServiceServer) Replicate(context.Context, *ReplicationRequest) (*ReplicationAck, error) {
